<%-- 
    Document   : index
    Created on : 29/11/2020, 06:53:09 AM
    Author     : AxelHOOLIC
--%>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">PeruDelivery</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Controlador?accion=Carrito" tabindex="-1" aria-disabled="true"><i class="fas fa-cart-plus">(<label style="color: coral">${contador}</label>)</i>carrito</a>
                </li>
            </ul>
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-header">
                        <label for="">${p.getNombres()}</label>
                    </div>
                    <div class="card-body">
                        <i>$.${p.getPrecio()}</i>
                        <img src="${p.getImg()}" alt="imagenProducto" width="200" height="180">
                    </div>
